...
@Component({
  selector: 'app-gestion-doc-publi',
  templateUrl: './gestion-doc-publi.component.html',
  styleUrls: ['./gestion-doc-publi.component.scss']
})
export class GestionDocPubliComponent implements OnInit {
